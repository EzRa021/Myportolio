...
export const Project = () => {
  return (
    ...
    <div className="container-xxl py-6 pt-5 bg-dark text-white mb-5" style={{marginBottom:"400px"}}>
        <div className="container">
            <div className="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div className="col-lg-6 text-lg-end">
                    ...
                    <Link to="/Project">  <li className="mx-3 active text-white " data-filter="*">All Projects</li></Link>
                    <Link to="/Html"> <li className="mx-3 text-white" data-filter=".first">Html and Css</li></Link>
                    <Link to="/React">  <li className="mx-3 text-white" data-filter=".second">React</li></Link>
            ...
            {Projectdata.map((value, index) => {
              ...
              {Reactdata.map((details, index) => {
                return (
                  <>
                      <div className="col-lg-4 col-md-6 portfolio-item first contain" >
                    <div className="portfolio-img rounded overflow-hidden">
              ...
              {HtmlData.map((Data, index) => {
                return (
                  <>
                      <div className="col-lg-4 col-md-6 portfolio-item first">
                    <div className="portfolio-img rounded overflow-hidden">
                        <img className="img-fluid" src={Data.cover} alt=""/>
                        <div className="portfolio-btn">
                            <a className="btn btn-lg-square btn-outline-secondary border-2 mx-1" href={Data.cover} data-lightbox="portfolio"><i className="fa fa-eye"></i></a>
                            <a className="btn btn-lg-square btn-outline-secondary border-2 mx-1" href={Data.link}><i className="fa fa-link"></i></a>
                        </div>
                    </div>
                </div>
                  </>
